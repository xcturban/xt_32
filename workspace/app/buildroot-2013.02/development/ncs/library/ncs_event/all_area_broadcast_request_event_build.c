...
static ncs_event_data_t *ncs_all_area_broadcast_request_event_data_pack(int *evt_data_len)
{
...
ncs_event_t *ncs_all_area_broadcast_request_event_build(void)
{
	...
	evt_data = ncs_all_area_broadcast_request_event_data_pack(&evt_data_len);
	if (evt_data == NULL) {
